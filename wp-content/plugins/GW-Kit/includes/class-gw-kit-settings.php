...
class GW_Kit_Settings {
            ...
            <div class="gw-kit-tabs-container">
                <div class="gw-kit-tabs-list">
                    ...
                    <div class="gw-kit-new-env hidden">
                        <input type="text" 
                               class="new-env-name" 
                               placeholder="<?php _e('Environment name (e.g. production, staging)', 'gw-kit'); ?>">
    ...
    public static function sanitize_gtm_environments($input) {
        ...
        $sanitized = array();
        foreach ($input as $env_id => $env) {
            if (!isset($env['id'])) continue;
